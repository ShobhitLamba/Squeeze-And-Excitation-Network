# Squeeze and Excite Inception-v4 architecture
...
def se_inception_v4(nb_classes = 1001, load_weights = True):
    ...
    model = Model(init, output, name = "SE_Inception-v4")   
        
    return model


if __name__ == "__main__":
    se_inception_v4 = se_inception_v4()
    se_inception_v4.summary()